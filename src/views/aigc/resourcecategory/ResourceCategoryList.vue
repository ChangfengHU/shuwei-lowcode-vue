<template>
  <div>
    ...
    <!--字典弹窗-->
    <ResourceCategoryModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="aigc-resourceCategory" setup>
  //ts语法
  import {ref, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import ResourceCategoryModal from './components/ResourceCategoryModal.vue';
  import {columns,searchFormSchema} from './ResourceCategory.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteResourceCategory, batchDeleteResourceCategory, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './ResourceCategory.api';
  ...
  async function handleDelete(record) {
    await deleteResourceCategory({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteResourceCategory({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
